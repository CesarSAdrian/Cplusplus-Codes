...
Si ambos números son compatibles, el usuario gana. Si no lo son, la máquina gana.
...
int main(){
	...
	do{
		...
		if(op == 's' || op == 'S'){
		    ...
		    cout<<"\nLa maquina esta pensando un numero..."; //Primer artículo
		    
			//Inicializa la función de random
	  		srand (time(NULL));
	
	  		//Genera un número secreto del 1 al 5
	  		num_r = rand() % 5 + 1;
	  		
	  		cout<<"\n\nIngrese un numero cualquiera (del 1 al 5): "; //Segundo artículo
	    	cin>>num;
