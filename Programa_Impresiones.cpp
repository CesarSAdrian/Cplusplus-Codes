...
a) Ver su nombre en un rectángulo.
b) Imprimir un triángulo invertido.
c) Una pirámide trunca de altura a
		...
		cin>>op;
			...
			switch(op){
				...
				case 'a':
					...
					//Nombre dentro de un rectángulo
					cout<<"\nIngresa tu nombre: ";
					getline(cin, name, '\n');
					
					cout<<"\n\n";
					
					//Captura del tamaño del nombre
					size = name.length();
